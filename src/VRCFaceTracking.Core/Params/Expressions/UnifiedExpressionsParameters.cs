...
public static class UnifiedExpressionsParameters
{
    ...
    {
        var allParams = UnifiedTracking.AllParameters_v2.SelectMany(p => p.GetParamNames());
    ...
    public static readonly Parameter[] UnifiedCombinedShapes =
    {
        ...
        // Placeholder: Wire up to UnifiedLibManager.EyeStatus/ExpressionStatus when available
        new ConditionalBoolParameter(exp => (false, false), "EyeTrackingActive"),
        new ConditionalBoolParameter(exp => (false, false), "ExpressionTrackingActive"),
        new ConditionalBoolParameter(exp => (false, false), "LipTrackingActive")
