...
public class Filter : TrackingMutation
{
    ...
    EuroFilter[] shapes = null!;
    EuroFilter gazeLeftX = null!, gazeLeftY = null!;
    EuroFilter gazeRightX = null!, gazeRightY = null!;
    EuroFilter pupilLeft = null!, pupilRight = null!;
    EuroFilter opennessLeft = null!, opennessRight = null!;
    EuroFilter headYaw = null!, headPitch = null!, headRoll = null!;
    EuroFilter headPosX = null!, headPosY = null!, headPosZ = null!;
    ...
    public Filter()
    {
        ...
        gazeLeftX = new(); gazeLeftY = new();
        gazeRightX = new(); gazeRightY = new();
        pupilLeft = new(); pupilRight = new();
        opennessLeft = new(); opennessRight = new();
        headYaw = new(); headPitch = new(); headRoll = new();
        headPosX = new(); headPosY = new(); headPosZ = new();
